...
namespace CProfiles.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> EditInfo()
        {
            ...
            EditInfoModel model = new EditInfoModel { UserName = user.UserName, PhotoUrl = photo.ImageUrl };
            return View(model);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditInfo(EditInfoModel model)
        {
            ...
            else { model.PhotoUrl = photo.ImageUrl; }
            if (ModelState.IsValid)
            {
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser() { UserName = model.UserName, UserBase = userBase };
